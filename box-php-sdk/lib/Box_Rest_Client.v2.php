...
class Rest_Client {
	...
	*/
	private static function custom_curl($operation, $url, array $params = array(), array $header_opts)
	{
		$ch = curl_init();
...
class Box_Rest_Client {
	...
	*/
	public function create(Box_Client_Folder $folder) {
		$post_params = array(
			...
			'parent' => array( 'id'=>intval($folder->attr('parent_id')) )
		);
	...
	*/
	public function move_folder ($folder_id, $destination_parent_id, $new_name='')
	{
		...
		$put_params = array( 'parent'=>array('id'=>$destination_parent_id), 'name'=>$new_name );
